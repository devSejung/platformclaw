...
function createContext(
  ...
  const context = createBaseContext(gateway, sessions);
  const selectionState: { selectedId: string | null; scopeId: string | null } = {
    selectedId: "main",
    scopeId: options?.scopeId === undefined ? "main" : options.scopeId,
  };
  return Object.assign(context, {
    accessMode: options?.accessMode ?? context.accessMode ?? "operator",
    agentSelection: {
