...
describe("AgentsPage gateway lifecycle", () => {
  it("coerces personal-agent routes to an allowed panel", () => {
    const page = document.createElement("openclaw-agents-page") as TestAgentsPage;
    const currentGateway = gateway(snapshot(null));
    page.context = pageContext(
      currentGateway,
      agentsCapability(async () => files("main", "")),
      {
    ...
    page.routeData = { panel: "skills" } as AgentsRouteData;
    expect(page.agentsPanel).toBe("skills");
  });
