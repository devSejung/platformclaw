...
class PlatformClawMcpAdministrationElement extends HTMLElement {
  ...
  private renderedEditing: AdminMcpServer | null | undefined;
  ...
  private render(): void {
    // Rendering busy/error feedback must not erase the editor draft, including
    // unchecked and temporarily disabled fields. A different editor starts fresh.
    const draft =
      this.editing !== undefined && this.editing === this.renderedEditing
        ? [
