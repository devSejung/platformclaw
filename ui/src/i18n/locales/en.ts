...
export const en: TranslationMap = {
  ...
  memoryPage: {
    ...
    memories: {
      ...
      sourceFilter: "Filter current search results by source",
      sourceFilterHint: "Filter within these results",
      sourceAll: "All",
      sourceOrganizationFilter: "Organization",
  ...
  dreaming: {
    ...
    wiki: {
      ...
      graphMembership: "Index membership",
      graphReference: "Document reference",
      graphRelated: "Confirmed relationship",
      graphCandidate: "AI comparison candidate",
