...
export const en: TranslationMap = {
  ...
  dreaming: {
    ...
    wiki: {
      ...
      discardTitle: "Discard Wiki changes?",
      discardDescription: "Your unsaved Markdown changes will be lost.",
      discard: "Discard changes",
      sourceManaged: "The source content is managed automatically. Edit your notes below.",
      generatedReadOnly: "This generated page is read-only.",
      pageTooLargeReadOnly: "This page is too large to edit here.",
      sharedVaultReadOnly: "Editing shared-vault pages is unavailable here.",
      saved: "Saved. The Wiki indexes are up to date.",
      savedIndexPending: "Saved. Wiki indexing is still pending.",
      saveReloadFailed:
        "Saved, but the refreshed page could not be loaded. Reopen it to check the result.",
