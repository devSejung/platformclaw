...
export const en: TranslationMap = {
  ...
  platformClaw: {
    ...
    guide: {
      ...
      unavailable: "The guide could not be opened. Refresh the page and try again.",
      welcomeTitle: "Welcome to PlatformClaw",
      welcomeBody: "Take a quick tour of the tools you will use most often.",
      chatTitle: "Chat with your Agent",
      chatBody: "Start work here. Each conversation keeps its own session context.",
      sessionsTitle: "Manage sessions",
      sessionsBody: "Open, organize, and return to your previous conversations.",
      tasksTitle: "Track work",
      tasksBody: "Review tasks and scheduled automation without losing your chat context.",
      workLocationTitle: "Choose where work runs",
      workLocationBody: "Switch between the Basic workspace and your assigned development VM.",
      skillsTitle: "Extend your Agent",
      skillsBody: "Install Skills and connect approved MCP services for your work.",
      reopenTitle: "Open this guide anytime",
      reopenBody: "Use the Guide button whenever you want to review these features again.",
    },
    skills: {
  ...
  skillHubPage: {
    ...
    unassignedOwnersHelp:
      "Skills appear here when the configured primary administrator is unavailable.",
