...
export const en: TranslationMap = {
  ...
  dreaming: {
    ...
    wiki: {
      ...
      write: "Write",
      preview: "Preview",
      saved: "Saved. Showing the latest server version.",
      savedIndexPending: "Saved. Search and graph refresh are pending; refresh to retry indexing.",
      saveReloadFailed: "The document was saved, but the latest version could not be reloaded.",
      sourceManaged: "The source content is managed by synchronization. Only Notes are editable.",
      generatedReadOnly:
        "This generated report is read-only and will be replaced by the next compile.",
      pageTooLargeReadOnly: "This page is too large for safe browser editing.",
