...
export const en: TranslationMap = {
  ...
  platformClaw: {
    ...
    voc: {
      ...
      subject: "Subject",
      description: "Details",
      subjectPlaceholder: "Please enter a title",
      descriptionPlaceholder:
        "- Pain points\n- Things that would be nice to improve\n- Features that would be nice to add",
      register: "Register",
      confirm: "Confirm",
      confirmBody: "Register this VOC in Jira?",
      submitting: "Registering…",
      success: "Your VOC was registered.",
      failed: "VOC registration failed. Please try again.",
    ...
    execution: {
      ...
      useBasic: "Use Basic workspace",
      useVm: "Use My development VM",
      boundary: "Conversation and Agent settings stay. Files and processes do not move.",
      assignedVm: "Assigned development VM",
      noVm: "No development VM assigned",
      noVmHelp: "You can keep using the Basic workspace. Ask an administrator if you need a VM.",
      selectVm: "Choose a development VM",
      vmChoice: "Development VM",
      linuxAccount: "Linux account",
      selectionHelp:
        "Your account ID is suggested automatically. Change it only when your Linux account is different.",
      connectVm: "Test and save VM",
      changeVm: "Test and change VM",
      noAvailableVm: "No development VM is currently available.",
      switchBasicToChange: "Switch to the Basic workspace before changing or releasing your VM.",
      release: "Release VM",
      releaseConfirmTitle: "Release this VM assignment?",
      releaseConfirmBody:
        "The VM files and background processes will remain. The saved AD credential will be removed.",
      releaseConfirm: "Release assignment",
      password: "AD password",
      saveAndTest: "Save after connection test",
      codingAgents: "Coding agents",
      useAgent: "Allow {agent}",
      agentSavedOn: "Saved permission: on",
      agentSavedOff: "Saved permission: off",
      agentSetupNeeded: "Setup needed before this agent can be used",
      agentUnsaved: "Unsaved changes · save to apply",
      agentOffHelp:
        "Off keeps this configuration, blocks new tasks, and does not stop active tasks.",
      agentNotChecked: "Connection not checked. Permission and connection status are independent.",
      agentNeedsRecheck: "Settings changed · check again for current status",
      agentDetectedPreview: "Detected preview · not saved and not a connection check",
      agentExecutable: "Executable",
      agentAbsolutePath: "Absolute VM path",
      agentCheckTokens:
        "Connection checks make a short agent request and may consume model tokens.",
      agentDetect: "Detect on VM",
      agentCheck: "Check connection",
      agentSave: "Save",
      agentSaveChanges: "Save changes",
      agentInstalled: "Installed: {version}",
      agentStageInstalled: "Installed",
      agentStageAuthentication: "Authentication",
      agentStageAcpConnection: "ACP connection",
      claudeGateway: "Company gateway",
      claudeGatewayConfigured: "4 settings configured",
      claudeGatewaySetup: "Setup required",
      claudeGatewayLiteralHelp:
        "Values are literal. Shell assignment quotes are syntax; do not paste the surrounding quote characters into these fields.",
      anthropicBaseUrl: "Inference endpoint",
      adminApiUrl: "Gateway admin endpoint",
      oidcIssuerUrl: "Identity provider issuer",
      oidcClientId: "OIDC application client ID",
      agentFieldRequired: "{field} is required.",
      agentFieldQuoted:
        "Remove the surrounding quote characters from {field}. Paste only the literal value.",
      agentConfigurationInvalid: "Coding agent settings are invalid.",
      agentReviewFields: "Review the highlighted {agent} fields.",
      agentSaved: "{agent} permission and settings saved.",
      agentDetected: "Detected {agent} settings. Review them, then save.",
      agentCheckFinished: "{agent} connection check finished.",
      agentDetecting: "Detecting settings from the VM…",
      agentChecking: "Checking connection…",
      agentSaving: "Saving settings…",
      agentEnterValue: "Enter a value",
      settingsSections: "Execution settings sections",
      workEnvironmentSettings: "Work environment settings",
      locationTab: "Work location",
      agentsTab: "Coding agents",
      currentlyActive: "Currently active",
      changeCredentials: "Change credentials",
      agentToggleShort: "Allow use",
      agentConfigure: "Settings",
      agentCollapse: "Done",
      agentSummaryNotChecked: "Not checked",
      agentSummaryAttention: "Needs attention",
      agentSummaryReady: "ACP ready",
      agentSummaryInstalled: "Installed · connection not verified",
      ...
      saveClaude: "Save and test",
      test: "Test connection",
      lastCheck: "Last successful check",
      neverChecked: "Not checked yet",
      workspacePending: "Workspace will be prepared after the first successful test",
      confirmTitle: "Change work location?",
      confirmBody:
    ...
    execCredentials: {
      ...
      title: "Personal exec credentials",
      intro:
      ...
      adminTitle: "Allowed environment variables",
      adminIntro: "Administrators manage names users may configure, never personal values.",
      configured: "Configured",
      ...
      remove: "Remove",
      add: "Add",
      empty: "No environment variables are allowed yet.",
      saved: "Saved.",
      failed: "Credential request failed.",
      sessionExpired: "Your session expired. Sign in again.",
    },
    mcp: {
      ...
      connect: "Connect",
      reconnect: "Reconnect",
      connectLabel: "Connect {server} with OAuth",
      reconnectLabel: "Reconnect {server} with OAuth",
      save: "Save",
      saveLabel: "Save credentials for {server}",
      remove: "Remove",
      removeLabel: "Remove credentials for {server}",
      removeConfirm:
        "Remove the saved credentials for {server}? The Agent will lose access immediately.",
      token: "Enter token",
      tokenLabel: "Bearer token for {server}",
      apiKey: "Enter API key",
      apiKeyLabel: "API key for {server}",
      secretRequired: "Enter credentials for {server} before saving.",
      scope: "Scope: {scope}",
      personalTitle: "Your MCP credentials",
      personalIntro:
        "Only servers that require your own credential appear here. Organization-wide and credential-free servers work automatically.",
      automatic:
        "Nothing is blocked: servers that need no personal credential require no setup here.",
      empty: "No administrator-approved personal credential is required.",
      saved: "MCP connection updated.",
      oauthConnected: "OAuth connection completed.",
      oauthFailed: "OAuth connection failed. Try connecting again.",
      failed: "MCP connection request failed.",
      sessionExpired: "Your session expired. Sign in again.",
      close: "Close",
      refresh: "Refresh",
      adminTitle: "MCP server administration",
      adminIntro:
        "Register approved servers, choose who supplies credentials, and block individual tools. New servers allow all tools by default.",
      adminAdd: "Add MCP server",
      ...
      adminNoCredentialShort: "No credential",
      adminSharedCredential: "Organization-wide shared credential",
      adminPersonalCredential: "Each employee connects their own credential",
      adminAuth: "Credential type",
      adminChooseAuth: "Choose credential type",
      adminHeader: "API-key header",
      adminSharedSecret: "Shared secret (required when saving)",
      adminScope: "OAuth scope",
      adminBlockedTools: "Blocked tools",
      adminBlockedToolsHelp:
        "Optional. Enter one exact tool name or glob per line. Leave empty to allow every tool.",
      adminEnabled: "Server enabled",
      adminAllTools: "All tools allowed",
      adminCliToolPolicy: "CLI-managed tool policy",
      adminBlockedCount: "{count} tools blocked",
      adminEdit: "Edit",
      adminEnable: "Enable",
      adminDisable: "Disable",
      adminCliManaged: "Advanced server; edit with the server CLI",
      adminRemoveConfirm: "Remove MCP server {server} for every employee?",
      adminSaved: "MCP server settings updated.",
      adminFailed: "MCP server administration request failed.",
    },
    vmAdmin: {
      open: "VM administration",
      title: "VM administration",
      intro: "Set up trusted access, development VMs, and employee assignments.",
      close: "Close",
      refresh: "Refresh",
      loading: "Loading VM administration data…",
      requestFailed: "VM administration request failed.",
      saved: "VM administration settings updated.",
      endpoints: "SafeConnect endpoints",
      endpointHelp:
        "Approve a host key only after verifying its fingerprint through a trusted channel.",
      hosts: "Development VMs",
      allocations: "Employee assignments",
      allocationHelp: "Employees choose from active VMs. Administrators can revoke access here.",
      disableEndpoint: "Disable endpoint",
      enableEndpoint: "Enable endpoint",
      disableHost: "Disable VM",
      enableHost: "Enable VM",
      hostEditRequiresActiveEndpoint: "Enable this VM's SafeConnect endpoint before editing it.",
      revokeAllocation: "Revoke assignment",
      confirmTitle: "Confirm change",
      confirmBody: "Apply this change to {label}? Running work is never moved automatically.",
      confirm: "Confirm",
      cancel: "Cancel",
      audit: "Recent VM audit events",
      noItems: "Nothing configured yet.",
      label: "Label",
      endpointHost: "SafeConnect host",
      port: "SSH port",
      adDomain: "AD domain",
      createEndpoint: "Add endpoint",
      probeBeforeSave: "Check connection before saving",
      probeEndpoint: "Check connection and host key",
      probeSucceeded: "DNS, TCP, SSH banner, and ED25519 host-key checks passed.",
      verifyHostKey: "Verify the SafeConnect host key",
      hostKeyTargetHelp:
        "This is the SafeConnect SSH server key, not the development VM key. Confirm the fingerprint through a trusted channel before approval.",
      keyCommentHelp:
      ...
      vm: "Development VM",
      linuxAccount: "Linux account",
      pendingApproval: "Host key approval required",
      active: "Active",
      disabled: "Disabled",
      unassigned: "No unassigned employees available.",
      noActiveHosts: "No active VM is available.",
    },
  },
  optionCard: {
  ...
  skillsPage: {
    ...
    skillHub: {
      title: "Skill Hub",
      subtitle: "Search the shared registry and install a selected version into this workspace.",
      searchPlaceholder: "Search Skill Hub",
      search: "Search",
      searching: "Searching…",
      loading: "Loading Skill Hub…",
      noResults: "No Skill Hub results",
      details: "Details",
      version: "Version",
      unavailable: "unavailable",
      ...
      publishedNeedsOwnershipReview:
        "Published {skill} to the registry, but organization access changed. The skill is private until an administrator assigns an eligible owner; administrators were notified.",
  ...
  subtitles: {
    ...
    skillHub: "Find, review, and install company skills.",
  ...
  memoryPage: {
    ...
    memories: {
      ...
      longTermDescription: "The durable context your Agent keeps in MEMORY.md.",
      longTermEmpty:
        "MEMORY.md is empty. Your Agent will add durable context when there is something worth keeping.",
      previewHint: "Open the full long-term memory.",
      recentTitle: "Recent daily memory",
      recentDescription:
        "Canonical Markdown entries from this Agent's memory folder, newest first.",
      recentEmpty: "No daily memory entries yet.",
      recentUnavailable:
      ...
      browseUpdateRequired: "Update the Gateway to browse personal memory from the Control UI.",
      previewUnavailable: "A full preview requires a newer Gateway.",
      refresh: "Refresh personal memory",
      refreshing: "Refreshing…",
      refreshed: "Personal memory refreshed.",
      connecting: "Connecting to the Gateway…",
      reconnecting: "Reconnecting to the Gateway. Personal memory will refresh when it returns.",
      ...
      sourceWiki: "Personal Wiki",
      organizationUnavailable: "Organization memory is temporarily unavailable.",
      wikiUnavailable: "Personal Wiki search is temporarily unavailable.",
      wikiMethodUnavailable: "Personal Wiki search is not available on this Gateway.",
      personalUnavailable: "Personal memory search is temporarily unavailable.",
      personalMethodUnavailable: "Personal memory search is not available on this Gateway.",
      staleResults: "The memory index is refreshing. These results may be out of date.",
      ...
      detailNotFound: "This memory is no longer available or you no longer have access.",
    },
    promotions: {
      ...
      retire: "Retire",
      purge: "Hard purge",
      decisionReason: "Reason for this approval or rejection",
  ...
  skillHubPage: {
    companyRegistry: "Company Skill Registry",
    heroTitle: "Share proven skills across your team",
    heroDescription:
      "Search approved workspace skills, inspect exact versions, and choose where to install them.",
    namespacesAvailable: "Connected · {count} publishing namespaces",
    ...
    scannerNotAvailable: "Scanner unavailable",
    scannerPending: "Scanner pending",
    scannerPassed: "Scanner passed",
    scannerFailed: "Scanner found risks",
    versionDraft: "Draft",
    versionScanning: "Scanning",
    versionScanFailed: "Scan failed",
    versionUploaded: "Uploaded",
    versionPendingReview: "Pending review",
    ...
    upgrade: "upgrade",
    downgrade: "downgrade",
    confirmVersionChange: "Replace installed version",
    notifications: "Notifications",
    notificationsTitle: "Open Skill Hub notifications",
    markAllRead: "Mark all read",
    noNotifications: "No Skill Hub notifications yet.",
    uploadZip: "Upload ZIP",
    uploadDescription:
      "Publish a complete skill package. The server validates SKILL.md and scans the archive before release.",
    chooseZip: "Choose a skill ZIP",
    uploadLimit: "ZIP · maximum 500 MB",
    fileTooLarge: "This ZIP is larger than the 500 MB upload limit.",
    slug: "Skill slug",
    publishZip: "Scan and publish ZIP",
    publishedZip: "Published {skill} from ZIP.",
    publishedNeedsOwnershipReview:
      "Published {skill} to the registry, but organization access changed. The skill is private until an administrator assigns an eligible owner; administrators were notified.",
    management: "Skill management",
    owner: "Owner",
    ownerUnassigned: "Admin unassigned queue",
    ownerYou: "You",
    ownerAssigned: "Assigned owner",
    employeeId: "Employee account ID",
    searchUsers: "Search by name or account ID",
    transferOwner: "Transfer owner",
    ownerTransferred: "Skill ownership transferred.",
    individualAccess: "Individual access",
    individualAccessHelp:
      "Grant access outside the selected Group or Part. Recipients cannot reshare.",
    grantAccess: "Grant access",
    accessGranted: "Individual access granted.",
    accessRevoked: "Individual access revoked.",
    revoke: "Revoke",
    forcePublish: "Force publish",
    forcePublishHelp:
      "The current scan found risks. Publishing is audited and all administrators are notified.",
    forceReason: "Required reason (at least 10 characters)",
    forceConfirm: "I reviewed the current scanner findings and accept the risk.",
    ...
    globalRestrictedHelp:
      "Global bindings start restricted. Activate them only after reviewing organization-wide visibility.",
    changeReason: "Change reason",
    activateGlobal: "Activate Global",
    restrictGlobal: "Restrict Global",
    confirmNamespaceAction: "Confirm namespace change",
    ...
    noBindings: "No namespace bindings configured.",
    unassignedOwners: "Unassigned owners",
    unassignedOwnersHelp:
      "Skills appear here when their owner becomes inactive or ineligible for the bound scope.",
    noUnassignedOwners: "No skills are waiting for an owner.",
  },
  labsPage: {
    intro:
  ...
  dreaming: {
    ...
    wiki: {
      ...
      cardsView: "Cards",
      graphView: "Graph",
      loadingGraph: "Loading wiki graph…",
      emptyGraph: "No linked wiki pages yet",
      emptyGraphHint: "Create links between wiki pages to see their connections here.",
      graphError: "Could not load the wiki graph",
  ...
  cron: {
    ...
    form: {
      ...
      personalAnnounce: "Send to last conversation",
      ...
      modelCurrentSelection: "Current selection",
      thinking: "Reasoning",
