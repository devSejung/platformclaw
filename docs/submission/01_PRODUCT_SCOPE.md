...
| `submission/global-skills/`                      | PlatformClaw | 평가용 Global Skill·Python source                   | 예정    | IR-003~IR-007                       | KEEP              | 제출 source provenance         | Skill별 test + final gate       |
| `submission/external-components/board-farm-mcp/` | External     | 별도 MCP repo provenance·선택적 sanitized snapshot  | 미사용  | 별도 service                        | KEEP              | 평가 source/provenance         | commit·license·contract proof   |
