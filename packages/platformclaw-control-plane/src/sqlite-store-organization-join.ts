...
import { SqliteControlPlaneOrganizationJoinReadStore } from "./sqlite-store-organization-join-read.js";

export abstract class SqliteControlPlaneOrganizationJoinStore extends SqliteControlPlaneOrganizationJoinReadStore {
