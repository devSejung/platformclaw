...
export const PLATFORMCLAW_WEB_ALLOWED_PARAMS = new Map<string, ReadonlySet<string>>([
  ...
  ["agents.workspace.list", new Set(["agentId", "path"])],
  ...
  ["sessions.branches.list", new Set(["sessionKey", "agentId"])],
  ["sessions.branches.switch", new Set(["sessionKey", "agentId", "leafEntryId"])],
  ["sessions.compact", new Set(["key", "agentId"])],
  ["sessions.compaction.branch", new Set(["key", "agentId", "checkpointId"])],
  ["sessions.compaction.list", new Set(["key", "agentId"])],
  ["sessions.compaction.restore", new Set(["key", "agentId", "checkpointId"])],
  ...
  ["users.self", new Set()],
  ["wiki.delete", new Set(["agentId", "path", "expectedContentHash"])],
  ["wiki.document.get", new Set(["agentId", "lookup"])],
  ["wiki.document.save", new Set(["agentId", "path", "editMode", "content", "expectedRevision"])],
