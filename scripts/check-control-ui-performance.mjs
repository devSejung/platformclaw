...
export const CONTROL_UI_PERFORMANCE_BUDGETS = Object.freeze({
  ...
  // 326 KiB covers the 2026.8.1 branch-point UI controllers plus PlatformClaw's
  // startup account, restricted-route overlay, and visible ACP harness badges.
  startupJsGzipBytes: 326 * KIB,
